...
public class Gauche implements Command {

    private Map<Character, Pivoter> pivoterStrategy;

    public Gauche() {
        this.pivoterStrategy = new HashMap<>();
        this.pivoterStrategy.put('N', Pivoter.TO_WEST);
        this.pivoterStrategy.put('W', Pivoter.TO_SOUTH);
        this.pivoterStrategy.put('S', Pivoter.TO_EAST);
        this.pivoterStrategy.put('E', Pivoter.TO_NORTH);
    }
